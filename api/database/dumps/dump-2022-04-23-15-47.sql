...
VALUES
  (2, 1, 1, 1, '2022/04/23-12:43', 3000.00, 'Efectivo');
INSERT INTO
  `buy` (
    `idbuy`,
    `id_user`,
...
VALUES
  (3, 1, 1, 1, '2022/04/23-15:33', 1000.00, 'AAA');
INSERT INTO
  `buy` (
    `idbuy`,
    `id_user`,
...
VALUES
  (4, 1, 1, 1, '2022/04/23-15:35', 2000.00, 'AAA');
INSERT INTO
  `buy` (
    `idbuy`,
    `id_user`,
...
VALUES
  (5, 1, 1, 1, '2022/04/23-15:43', 2000.00, 'aaa');
...
VALUES
  (2, 7790150355077, 2, 20.00, 100.00);
INSERT INTO
  `buy_product` (
    `idbuy_product`,
    `id_product`,
...
VALUES
  (3, 7790150240274, 2, 10.00, 100.00);
INSERT INTO
  `buy_product` (
    `idbuy_product`,
    `id_product`,
...
VALUES
  (4, 7790150240274, 3, 10.00, 100.00);
INSERT INTO
  `buy_product` (
    `idbuy_product`,
    `id_product`,
...
VALUES
  (5, 7790036975108, 4, 10.00, 200.00);
INSERT INTO
  `buy_product` (
    `idbuy_product`,
    `id_product`,
...
VALUES
  (6, 7790036975108, 5, 10.00, 200.00);
...
VALUES
  (
    ...
    0,
    'santi',
    '$2b$08$4l/THYY7Ij52q1ZXiPrgweMwq/4gAA0.KZVOKVHaxH7bB7a4x7pQy'
  );
