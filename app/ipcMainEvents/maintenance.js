...
module.exports = ({
    ...
    ipcMain.handle('update-general-info', (e, {
        fantasyName,
        bussinesName,
        taxName,
        taxPercentage, 
    ...
    ipcMain.handle('update-branch-info', (e, {
        idBranch,
        branchName,
        cuit,
        dirStreet,
    ...
    let newUser;
    ipcMain.on('add-user', (e, {permissions, idEmplooy, branches}) => {
        if(permissions && idEmplooy && branches){
